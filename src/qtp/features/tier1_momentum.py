...
@reg.register("ret_1d", FeatureTier.TIER1_MOMENTUM, lookback_days=2,
              description="1-day simple return")
def ret_1d(df: pl.DataFrame) -> pl.Series:
    return df["close"].pct_change(1).alias("ret_1d")


@reg.register("ret_5d", FeatureTier.TIER1_MOMENTUM, lookback_days=6,
              description="5-day return (1 week)")
def ret_5d(df: pl.DataFrame) -> pl.Series:
    return df["close"].pct_change(5).alias("ret_5d")


@reg.register("ret_21d", FeatureTier.TIER1_MOMENTUM, lookback_days=22,
              description="21-day return (1 month)")
def ret_21d(df: pl.DataFrame) -> pl.Series:
    return df["close"].pct_change(21).alias("ret_21d")


@reg.register("ret_63d", FeatureTier.TIER1_MOMENTUM, lookback_days=64,
              description="63-day return (3 months)")
...
@reg.register("rsi_14", FeatureTier.TIER1_MOMENTUM, lookback_days=30,
...
@reg.register("macd_hist", FeatureTier.TIER1_MOMENTUM, lookback_days=35,
...
@reg.register("macd_signal", FeatureTier.TIER1_MOMENTUM, lookback_days=35,
...
@reg.register("dist_sma20", FeatureTier.TIER1_MOMENTUM, lookback_days=25,
...
@reg.register("dist_sma50", FeatureTier.TIER1_MOMENTUM, lookback_days=55,
...
@reg.register("dist_sma200", FeatureTier.TIER1_MOMENTUM, lookback_days=210,
...
@reg.register("roc_10", FeatureTier.TIER1_MOMENTUM, lookback_days=11,
              description="Rate of Change (10-day)")
def roc_10(df: pl.DataFrame) -> pl.Series:
    return df["close"].pct_change(10).alias("roc_10")


@reg.register("roc_20", FeatureTier.TIER1_MOMENTUM, lookback_days=21,
              description="Rate of Change (20-day)")
